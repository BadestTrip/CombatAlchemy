...
**Date:** 2026-09-02  
**Status:** Historical approved proposal; visual requirements superseded and new interactions deferred
...
> Scope update, 2026-09-12: the
> [approved pixel-art conversion](../plans/2026-09-12-pixel-art-conversion.md)
> takes precedence over this proposal's painterly/noir rendering, resolution,
> blur, palette, and animation requirements. The next pass uses a 640 x 360
> native pixel canvas, an eight-value grayscale foundation, and selective
> alchemical color across every current screen.
>
> Journal-based entry, vessel-based settings, candle exit, and other new diegetic
> interactions below remain a separate deferred proposal, not implemented
> behavior or hidden requirements of the conversion. Restyle the current menu,
> pause, settings, and transition while preserving their behavior first.
> Preserve this document as design history; consult
> [Style and Vision](../../STYLE_AND_VISION.md) for current art rules and
> [Project Architecture](../../PROJECT_ARCHITECTURE.md) for current code.
