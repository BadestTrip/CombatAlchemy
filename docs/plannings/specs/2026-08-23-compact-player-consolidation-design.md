...
> Historical implementation design. As of 2026-09-12, the compact skeleton is
> still the current runtime model, but new character production follows the
> [approved pixel-art conversion](../plans/2026-09-12-pixel-art-conversion.md).
> Its sprite-sheet presentation will replace the bone/part-art requirements
> below while preserving directional, socket, and immediate-potion behavior.
> The conversion is approved, not implemented; use
