...
> Brewing vision review, 2026-09-15: the approved
> [brewing and strategic placement direction](./2026-09-15-potion-brewing-vision-design.md)
> retains this ownership foundation. Larger staged recipes, storage, and dormant
> placement with deliberate activation are future work. The three-layer mixer,
> arming delay, proximity trigger, and expiry below describe the implemented
> slice, not the final constraints on brewing or long-term placement.

> Presentation review, 2026-09-12: the
> [approved pixel-art conversion](../plans/2026-09-12-pixel-art-conversion.md)
> preserves this design's recipe/instance/entity ownership and one-use behavior.
> Bone-based attachment or polygon visuals below describe the implementation
> basis, not a requirement for new art. Keep the stable socket lookup and same
> physical entity while changing presentation. Future storage remains intended
> but is not added by the conversion. See
> [Project Architecture](../../PROJECT_ARCHITECTURE.md) for current implementation.
